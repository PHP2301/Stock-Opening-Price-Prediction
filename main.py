...
def log_prediction_to_file(ticker, last_date, last_close, risk_level, risk_ratio, xgb_val, xgb_lower, xgb_upper, trans_val, trans_lower, trans_upper, rate_today=None):
    ...
    log_path = os.path.join("results", "predictions_history.txt")
...
def main():
    ...
    if INDIVIDUAL_TRAINING:
        ...
        for t in TICKERS:
            joblib.dump(transformers[t].feature_scaler, f'models/feature_scaler_{t}.pkl')
            joblib.dump(transformers[t].target_scaler, f'models/target_scaler_{t}.pkl')
