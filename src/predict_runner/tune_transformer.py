...
if __name__ == "__main__":
    print("🚀 [HỆ THỐNG] Khởi động Tìm kiếm Siêu tham số tối ưu bằng Optuna...")
    
    # Tải dữ liệu mẫu của mã META để tối ưu hóa đại diện
    ticker = "META"
    print(f"📦 Đang tải dữ liệu huấn luyện cho mã kiểm thử: {ticker}...")
    ...
    print(f"📊 Dữ liệu tuning: Train = {X_train.shape[0]} mẫu, Val = {X_val.shape[0]} mẫu")
    ...
    # Lưu các tham số tối ưu vào thư mục models/ để dùng chung
